...
class FacebookContextActionSubscriber implements EventSubscriberInterface
{
    ...
    public static function getSubscribedEvents()
    {
        return array(
         ...
         GameEvents::ACTION_ERROR => 'onErrorAction',
      );
    }
    ...
    {
        $leadPlayer = $e->getGame()->getLeadPlayer();
        $message = $leadPlayer->getToken() !== null ? 'You win !' : 'You loose !';
        $this->api->sendMessage($e->getRecipient(), $message);
    }
    ...
    public function onErrorAction(GameEvent $e)
    {
        $payload = $e->getPayload();
        $this->api->sendMessage($e->getRecipient(), substr($payload['message'], 0, 317) . '...');
    }
}
